...
| [`firstdown_studio_2026`](sources/firstdown_studio_2026/) | 2026 QB/RB/WR boards — **post-trade 2026 team per skill player** + projected Week-1 starter per team + FDS's prop-driven projections | First Down Studio | 2026 |
...
python3 nfl/sources/firstdown_studio_2026/pipeline.py # re-parses committed board captures; no fetch
